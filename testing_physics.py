...
for f in csv_files:
    ...
    stall = 15  # For corrupt data 
    stallUpper = 20  # stallUpper - stall = times under the tresh before velocity is set to 0
    ...
    for i in range(len(data)):
        ...
        # if a bit of time no accel change and before begining of movementX set accel to 0
